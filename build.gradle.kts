...
subprojects {
    ...
    extensions.configure<BaseExtension> {
        ...
        defaultConfig {
            ...
            minSdk = 21
            targetSdk = 35
            buildConfigField("String", "CFG_BASE_1", "\"${queryConfigProperty("fanvpn.cfg.base.1") ?: ""}\"")
            buildConfigField("String", "CFG_BASE_2", "\"${queryConfigProperty("fanvpn.cfg.base.2") ?: ""}\"")
            buildConfigField("String", "CFG_BASE_3", "\"${queryConfigProperty("fanvpn.cfg.base.3") ?: ""}\"")
            ...
            if (!isApp) {
                ...
                setProperty("archivesBaseName", "FanVPN-$versionName")
            }
        }
